...
$hu312a=$_POST['subcode5a'];
 ...
 if($row)
 {
  ...
  // need to update
  $sql33="UPDATE `students_detail34` SET `SECTION`='$section',`TeacherName`='$teacher',`UpdatedAt`=current_timestamp(),`21CS301`='$cs301',`21CS302`='$cs302',`21CS303`='$cs303',`21CS304`='$cs304',`21HU312`='$hu312',`CIE`=250,`Obtained`='$total',`PERCENTAGE`='$per',`CLASS_HELD`=50,`CLASSES_ATTENDED`=20
...
,`21cs301a`, `21cs302a`, `21cs303a`, `21cs304a`, `21hu312a`) VALUES (NULL,'.$nam.','.$usn.','.$section.','.$teacher.',current_timestamp(),'.$cs301.','.$cs302.','.$cs303.','.$cs304.','.$hu312.',250,'.$total.','.$per.',50,25,'.$cs301a.','.$cs302a.','.$cs303a.','.$cs304a.','.$hu312a.')";
